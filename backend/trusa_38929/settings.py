"""
Django settings for trusa_38929 project.
...
WSGI_APPLICATION = 'trusa_38929.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trusa_38929 API",
    "DESCRIPTION": "API documentation for trusa_38929 App",
    "VERSION": "v1",
}
